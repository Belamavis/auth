...
<html>
	...
	<body>
		<div id="login" class="enter">
			...
			<div class="error" id="wrong_name_or_password">
				<p>Неверно введено имя пользователя или пароль!</p>
			</div>
		</div>
		<div id="register" class="enter clearfix">
			<p class="title">Регистрация</p>
			<form id="register_site" action="../register_site.html" method="POST"></form>
